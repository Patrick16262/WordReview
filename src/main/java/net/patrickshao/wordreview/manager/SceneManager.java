...
import net.patrickshao.wordreview.controller.RootPane;
...
public class SceneManager {
    private static List<VBox> fixedPages = new ArrayList<VBox>();
    ...
    public static void setPage(int index) {
        VBox page = fixedPages.get(index);
        page.setLayoutY(0);
        page.setLayoutX(0);
    ...
    private static void loadNodes() throws IOException {
        ...
        fixedPages.add(getLoader("first-view.fxml").load());
